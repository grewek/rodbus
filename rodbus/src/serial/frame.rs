...
use crate::common::frame::{Frame, FrameDestination, FrameHeader, FrameInfo, FrameRecords, FrameType, FrameWriter, FunctionField};
...
pub(crate) fn format_rtu_pdu(
    ...
    msg.serialize(&mut FrameRecords::new(), cursor)?;
